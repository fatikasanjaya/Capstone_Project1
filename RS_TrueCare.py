            ...
            while True:
                ...
                while True:
                    ...
                    if confirm_edit == 'no':
                        ...
                        break  # Menghentikan pengeditan dan keluar dari loop
                        ...
                        while True:
                            ...
                            if edit_choice == 1:
                                ...
                                new_umur_str = pyip.inputStr("Masukkan umur pasien baru: ")
                                if new_umur_str:
                                    try:
                                ...
                                new_kelas = pyip.inputStr("Masukkan kelas kamar baru (VIP/I/II/III): ").upper()
